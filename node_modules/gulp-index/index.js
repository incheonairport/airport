...
`,
    ...
    'title': '인천국제공항 퍼블리싱 리스트',
    // Title template function used to construct the title section
    'title-template': (title) =>`<h1 class="index-title">${title}</h1>
`,
    ...
    'section-template': (sectionContent) => `<section class="index-section">
${sectionContent}</section>
`,
    // Section heading function used to construct each section heading
    'section-heading-template': (heading) => `<h2 class="index-section-heading">${heading}</h2>
`,
    // List function used to construct a file list
    'list-template': (listContent) => `<ul class="index-list">
${listContent}</ul>
`,
    // Item function used to construct each list item
    'item-template': (filepath, filename) => `<li class="index-item"><a class="index-item-link" href="${filepath ? filepath + '/' + filename : filename}">${filename}</a></li>
`,
